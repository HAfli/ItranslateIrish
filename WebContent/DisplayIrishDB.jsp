...
<h2 style="font-family: cursive; text-align: center;"><u>Irish to English Translation DB</u></h2>
	<s:iterator value="list2">
		<fieldset>
		<b>
			S.No.: <s:property value="sno" />
			<br />
			Irish Tweet: <s:property value="irish_tweet" />
			<br />
			Englsh Translation: <s:property value="eng_translate" />
			<br />
