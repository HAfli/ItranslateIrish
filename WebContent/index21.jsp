...
<body>
<s:hidden id = "inputtweet1" name = "inputtweet1"/>
<s:hidden id = "positive1" name = "positive1"/>
<s:hidden id = "negative1" name = "negative1"/>
<s:hidden id = "neutral1" name = "neutral1"/>
<s:hidden id = "tweetsentiment1" name = "tweetsentiment1"/>
...
<img src="images/adapt_logo.png" width="200" height="130" alt=""
	...
	<textarea id="title" name="title"  rows="4" cols="50" readonly="readonly" style="resize:none;"><s:property value="inputtweet1" /></textarea></h3>
	<h3>Sentiment of your tweet: <s:property value="tweetsentiment1"/></h3>
	<h3><u>Top Positive Tweets</u></h3>
	<s:subset start="0" count="10" source="top10posTweets1">
...
<div style="margin-top: 135px; margin-left: -400px; position: absolute;">
	...
	<s:subset start="0" count="10" source="top10negTweets1">
	<table border="1" width="350">
	<s:iterator>
...
<s:form action="sentimentanalysis.action" method="post">
	<s:hidden name = "inputtweet" value="%{inputtweet1}"/>
	<s:submit cssClass="button" method="sentimentAnalysis" key="label.sentimentenglish" align="center" />
</s:form>
</div>
<h3>Overall Sentiment of #GE16</h3>
<script src="https://d3js.org/d3.v3.min.js"></script>
<script>
var v1 = document.getElementById("positive1").value;
var v2 = document.getElementById("negative1").value;
var v3 = document.getElementById("neutral1").value;
